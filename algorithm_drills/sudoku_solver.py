...
print('board 0:')
solve_and_print_sols(board_0, 0, 0)

print('board 1:')
solve_and_print_sols(board_1, 0, 0)

print('board 2:')
solve_and_print_sols(board_2, 0, 0)
